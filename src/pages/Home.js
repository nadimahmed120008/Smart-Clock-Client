  ...
  return (
    <div>
      ...
      <Container className="collections my-5 mx-auto">
        ...
        >
          <Bounce>
            A wide range of collected Smart watches are stored for your different people with functionality and Fashion
          </Bounce>
        </p>
        <Row className="mx-0">
      ...
      <Container>
        <Bounce bottom cascade>
          ...
          <p style={{ maxWidth: "650px" }} className="text-center mx-auto mt-3">
            {" "}
            All of our smart watches are Authentic & original brands because we believe in authenticity and quality products.
          </p>
        </Bounce>
        {!products.length ? (
